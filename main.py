...
def Startlevel1():
    ...
    tiles.set_current_tilemap(tilemap("""
        nivel1
    """))
    tiles.place_on_tile(mySprite, tiles.get_tile_location(1, 12))
    scene.camera_follow_sprite(mySprite)
    mySprite.set_velocity(10, 10)
    myEnememy = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    tiles.place_on_tile(myEnememy, tiles.get_tile_location(1, 14))
    myEnememy.follow(mySprite, 10)
    myEnememy.set_flag(SpriteFlag.GHOST_THROUGH_WALLS, True)
def intro_music():
    music.play_melody("E A F G E F G A ", 120)
...
def intro():
    story.print_dialog("\"Hello I´m Aram and this is my story\"",
        80,
        90,
        50,
        150,
        10,
        1)
    mySprite.set_position(7, 65)
    story.print_dialog("\"I was sent to deliver some pizza to a weird castle\"",
        80,
        90,
        50,
        150,
    ...
    scene.set_background_image(img("""
        9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
                ...
                bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    """))
    story.sprite_move_to_location(mySprite, 150, 65, 60)
    scene.set_background_image(img("""
    ...
    """))
    story.print_dialog("Now I'm trapped in here and need to scape avoiding the ghosts",
        80,
        90,
        50,
        150,
...
def on_on_overlap(sprite2, otherSprite):
    ...
    myEnememy.destroy()
    Startlevel3()
sprites.on_overlap(SpriteKind.enemy3, SpriteKind.player, on_on_overlap)

def on_countdown_end():
    game.splash("RUN AND AVOID THE GHOSTS")
    Startlevel1()
...
def Startlevel3():
    ...
    myEnememy = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy3)
    tiles.place_on_tile(myEnememy, tiles.get_tile_location(4, 14))
    myEnememy.follow(mySprite, 35)
    myEnememy.set_flag(SpriteFlag.GHOST_THROUGH_WALLS, True)
...
def on_on_overlap3(sprite4, otherSprite3):
    ...
    myEnememy.destroy()
    Startlevel2()
sprites.on_overlap(SpriteKind.enemy2, SpriteKind.player, on_on_overlap3)

def Op():
    global titleScreens
    titleScreens = sprites.create(assets.image("""
        titulo
    """), SpriteKind.Background)
    intro_music()
    titleScreens.destroy()
...
def Startlevel2():
    ...
    myEnememy = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy2)
    tiles.place_on_tile(myEnememy, tiles.get_tile_location(3, 12))
    myEnememy.follow(mySprite, 40)
    myEnememy.set_flag(SpriteFlag.GHOST_THROUGH_WALLS, True)
...
titleScreens: Sprite = None
myEnememy: Sprite = None
...
def on_forever():
    music.play_melody("E C E C G C F C ", 160)
    music.play_melody("F D F D A D G D ", 160)
forever(on_forever)
