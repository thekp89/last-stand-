namespace SpriteKind {
    export const noc = SpriteKind.create()
...
function Startlevel1 () {
    ...
    myEnememy = sprites.create(img`
        ...
        ........................
        `, SpriteKind.Enemy)
    tiles.placeOnTile(myEnememy, tiles.getTileLocation(1, 14))
    myEnememy.follow(mySprite, 10)
    myEnememy.setFlag(SpriteFlag.GhostThroughWalls, true)
}
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.stairLarge, function (sprite5, location2) {
...
function intro () {
    story.printDialog("\"Hello I´m Aram and this is my story\"", 80, 90, 50, 150, 10, 1)
    mySprite.setPosition(7, 65)
    story.printDialog("\"I was sent to deliver some pizza to a weird castle\"", 80, 90, 50, 150, 10, 1)
    scene.setBackgroundImage(img`
        ...
        bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
        `)
    story.spriteMoveToLocation(mySprite, 150, 65, 60)
    scene.setBackgroundImage(img`
        ...
        `)
    story.printDialog("Now I'm trapped in here and need to scape avoiding the ghosts", 80, 90, 50, 150, 10, 1)
...
sprites.onOverlap(SpriteKind.enemy3, SpriteKind.Player, function (sprite2, otherSprite) {
    info.changeLifeBy(-1)
    myEnememy.destroy()
    Startlevel3()
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorOpenNorth, function (sprite6, location3) {
    game.splash("LEVEL COMPLETE")
    myEnememy.destroy()
    Startlevel3()
})
function Startlevel3 () {
    ...
    myEnememy = sprites.create(img`
        ...
        ........................
        `, SpriteKind.enemy3)
    tiles.placeOnTile(myEnememy, tiles.getTileLocation(4, 14))
...
function Op () {
    titleScreens = sprites.create(assets.image`titulo`, SpriteKind.Background)
    intro_music()
...
function Startlevel2 () {
    ...
    myEnememy = sprites.create(img`
        ...
        ........................
        `, SpriteKind.enemy2)
    tiles.placeOnTile(myEnememy, tiles.getTileLocation(3, 12))
    myEnememy.follow(mySprite, 40)
    myEnememy.setFlag(SpriteFlag.GhostThroughWalls, true)
}
function intro_music () {
    music.playMelody("E A F G E F G A ", 120)
}
sprites.onOverlap(SpriteKind.enemy2, SpriteKind.Player, function (sprite4, otherSprite3) {
    info.changeLifeBy(-1)
    myEnememy.destroy()
    Startlevel2()
})
let titleScreens: Sprite = null
let myEnememy: Sprite = null
let mySprite: Sprite = null
Op()
mySprite = sprites.create(assets.image`Mona`, SpriteKind.Player)
intro()
let levels = [tilemap`nivel1`, tilemap`nivel0`, tilemap`nivel6`]
controller.moveSprite(mySprite)
mySprite.setStayInScreen(true)
forever(function () {
    music.playMelody("E C E C G C F C ", 160)
    music.playMelody("F D F D A D G D ", 160)
})
